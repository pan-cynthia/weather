      ...
      <div>
        ...
        <div className='mx-auto mt-10 flex justify-between w-2/3 space-x-5'>
          <div className='w-4/5 flex flex-col justify-between'>
            <Forecast datetime={weather.weatherData.time_h} temperature={weather.weatherData.temperature_2m} title='Hourly Forecast' icon='UilClock'/>
            <Forecast datetime={weather.weatherData.time_d} temperature={weather.weatherData.temperature_2m_max.slice(1, 6)} temperature2={weather.weatherData.temperature_2m_min.slice(1, 6)} title='Daily Forecast' icon='UilCalender'/>
          </div>
